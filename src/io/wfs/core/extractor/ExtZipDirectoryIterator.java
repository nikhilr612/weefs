...
final class ExtZipDirectoryIterator implements Iterator<Path> {
    ...
    ExtZipDirectoryIterator(Iterator<Path> delegate, ExtZipFileSystem fileSystem, DirectoryStream.Filter<? super Path> filter) {
